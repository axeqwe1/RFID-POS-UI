...
useEffect(() => {
  ...
  return (
    <div id="about-page" className="max-w-[1300px] mx-auto my-6 h-[85vh] pt-[95px]">
      <div className="w-full h-full py-6">
          <div id="header" className="header flex justify-center items-center">
            <h1 className='text-5xl'>Do You Have a Member?</h1>
          </div>

          <div className="main grid grid-cols-2 gap-6 h-full py-12">
              ...
              <div className="bg-base-100 shadow-sm w-full h-full">
